...
<body class="body-c">
    ...
    <div class="flex">
        ...
        <div class="card-mid bck-color-white"><br>
            <h3>Do you really want to Deactivate this user?<br><br></h3>
            <table>
                <thead>
                    <th>ID</th>
                    <th>User Id</th>
                ...
                <tbody>
                    ...
                    foreach ($records as $record) { ?>
                        <tr>
                            ...
                            <td><?php date("Y-m-d", strtotime($record['dateofbirth'])) ?></td>
    ...
    <div class="buttons">
        <div class="submit">
            <a class="nav-link nav-block nav-color nav-align" href="deactivate_user_op.php?userid=<?php print $record['userid'] ?>">Deactivate
            </a>
        </div>
        <div class="submit">
            <a class="nav-link nav-block nav-color nav-align" href="delete.php">Cancel
            </a>
        </div>
    </div>
