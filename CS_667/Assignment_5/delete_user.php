...
<body class="body-c">
    ...
    <div class="flex">
        ...
        <div class="card-mid bck-color-white"><br>
            <h3>Do you really want to delete this user?<br><br></h3>
            <table>
                <thead>
                    <th>ID</th>
                    <th>User Id</th>
    ...
    <div class="buttons">
        <div class="submit">
            <a class="nav-link nav-block nav-color nav-align" href="delete_user_op.php?userid=<?php print $record['userid'] ?>">Delete
            </a>
        </div>
        <div class="submit">
